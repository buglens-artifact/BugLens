...
if __name__ == "__main__":
    ...
    hash_count, num_test_cases = count_unique_hashes(benchmark_dir, skip_list)
    ...
    plt.xlabel("Commit Hashes", fontproperties='Times New Roman', fontsize=45)
    plt.ylabel("# Examinations", fontproperties='Times New Roman', fontsize=45)

    plt.bar(x, y)
    plt.show()
    
    # save_path = "/Users/zxt/Desktop/paper-bug-deduplication/plots/bar-commit-hashes-{}.pdf".format(
    #     benchmark_name,
    # )
