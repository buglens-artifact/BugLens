...
if 
  ...
  RunSafely.sh 3 1 /dev/null out1.txt ./small1 >/dev/null 2>&1 &&\
   gcc-4.3.0 -Os  -w -DINLINE= -DCSMITH_MINIMAL  -I/uusoc/exports/scratch/chenyang/csmith/runtime  -DWRAP_VOLATILES=0   small.c -o small2 > cc_out2.txt 2>&1 &&\
  ...
  ${CC_FIXED} -Os -w -DINLINE= -DCSMITH_MINIMAL -I/uusoc/exports/scratch/chenyang/csmith/runtime -DWRAP_VOLATILES=0 small.c -o small2_fixed > cc_out2_fixed.txt 2>&1 &&
  ...
  ${CC_BEFORE_FIXED} -Os -w -DINLINE= -DCSMITH_MINIMAL -I/uusoc/exports/scratch/chenyang/csmith/runtime -DWRAP_VOLATILES=0 small.c -o small2_before_fixed > cc_out2_before_fixed.txt 2>&1 &&
