...
if 
  ...
  ! grep 'comparison between pointer and integer' outa.txt &&\
   gcc-4.3.0 -Os  -w -DINLINE= -DCSMITH_MINIMAL  -I/uusoc/exports/scratch/chenyang/csmith/runtime  -DWRAP_VOLATILES=0   small.c -o small1 > cc_out1.txt 2>&1 &&\
  ...
  ${CC_FIXED} -Os -w -DINLINE= -DCSMITH_MINIMAL -I/uusoc/exports/scratch/chenyang/csmith/runtime -DWRAP_VOLATILES=0 small.c -o small1_fixed > cc_out1_fixed.txt 2>&1 &&
  ...
  ${CC_BEFORE_FIXED} -Os -w -DINLINE= -DCSMITH_MINIMAL -I/uusoc/exports/scratch/chenyang/csmith/runtime -DWRAP_VOLATILES=0 small.c -o small1_before_fixed > cc_out1_before_fixed.txt 2>&1 &&
