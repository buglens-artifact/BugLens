...
if 
  ...
  ! grep 'comparison between pointer and integer' outa.txt &&\
   gcc-4.3.0 -O1  -w -DINLINE= -DCSMITH_MINIMAL  -I/uusoc/exports/scratch/chenyang/csmith/runtime  -DWRAP_VOLATILES=0   small.c -o small1 > cc_out1.txt 2>&1 &&\
  RunSafely.sh 3 1 /dev/null out1.txt ./small1 >/dev/null 2>&1 &&\
   gcc-4.3.0 -O0  -w -DINLINE= -DCSMITH_MINIMAL  -I/uusoc/exports/scratch/chenyang/csmith/runtime  -DWRAP_VOLATILES=0   small.c -o small2 > cc_out2.txt 2>&1 &&\
  RunSafely.sh 3 1 /dev/null out2.txt ./small2 >/dev/null 2>&1 &&\
  ! diff out1.txt out2.txt &&\
  ${CC_FIXED} -O1 -w -DINLINE= -DCSMITH_MINIMAL -I/uusoc/exports/scratch/chenyang/csmith/runtime -DWRAP_VOLATILES=0 small.c -o small1_fixed > cc_out1_fixed.txt 2>&1 &&
  RunSafely.sh 3 1 /dev/null out1_fixed.txt ./small1_fixed >/dev/null 2>&1 &&
  ${CC_FIXED} -O0 -w -DINLINE= -DCSMITH_MINIMAL -I/uusoc/exports/scratch/chenyang/csmith/runtime -DWRAP_VOLATILES=0 small.c -o small2_fixed > cc_out2_fixed.txt 2>&1 &&
  RunSafely.sh 3 1 /dev/null out2_fixed.txt ./small2_fixed >/dev/null 2>&1 &&
  diff out1_fixed.txt out2_fixed.txt &&
  ${CC_BEFORE_FIXED} -O1 -w -DINLINE= -DCSMITH_MINIMAL -I/uusoc/exports/scratch/chenyang/csmith/runtime -DWRAP_VOLATILES=0 small.c -o small1_before_fixed > cc_out1_before_fixed.txt 2>&1 &&
  RunSafely.sh 3 1 /dev/null out1_before_fixed.txt ./small1_before_fixed >/dev/null 2>&1 &&
  ${CC_BEFORE_FIXED} -O0 -w -DINLINE= -DCSMITH_MINIMAL -I/uusoc/exports/scratch/chenyang/csmith/runtime -DWRAP_VOLATILES=0 small.c -o small2_before_fixed > cc_out2_before_fixed.txt 2>&1 &&
