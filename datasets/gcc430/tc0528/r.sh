...
if 
  ...
  ! grep 'comparison between pointer and integer' outa.txt &&\
   /uusoc/exports/scratch/chenyang/compilers/compiler-install/gcc-430/bin/gcc-430 -O1  -w -DINLINE= -DCSMITH_MINIMAL  -I/uusoc/exports/scratch/chenyang/csmith/runtime  -DWRAP_VOLATILES=0   small.c -o small1 > cc_out1.txt 2>&1 &&\
